...
#Integration with Google Login API (Google Cloud OAuth integration API) 

app.secret_key = "Resume_screening"
os.environ["OAUTHLIB_INSECURE_TRANSPORT"] = "1"
GOOGLE_CLIENT_ID = "439440675623-iru1v84ridsnu2dv0jo9eqlntvo2kgrd.apps.googleusercontent.com"
...
# mongoDB Connection, setup of folder directory where resumes are uploaded, loading of pre-trained ml models 


UPLOAD_FOLDER = 'static/resumes'
app.config['UPLOAD_FOLDER']=UPLOAD_FOLDER
app.config['MONGO_URI']="mongodb+srv://div:root@cluster0.mg9fski.mongodb.net/RMR"
mongo.init_app(app)
...
def uploadResume():
    if 'user_id' in session and 'user_name' in session:
        ...
        return render_template("index.html", errMsg="Login First")
    #return render_template("EmployeeDashboard.html", errorMsg="An error occurred.")
